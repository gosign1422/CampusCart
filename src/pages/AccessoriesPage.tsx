  ...
  return (
    <div className="container mx-auto px-4 pt-24 pb-12">
      <div className="flex flex-col items-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Fashion Accessories</h1>
        ...
        <p className="mt-4 text-spotify-lightgray text-center max-w-2xl">
          ...
          From stylish bags to statement pieces, find the perfect complement to your outfit.
        </p>
      </div>
